...
class FeatureExtractor:
    def __init__(self, sample_rate=22050, n_fft=2048, hop_length=512, n_mels=128, n_mfcc=20):
    ...
    def extract(self, file_path, duration_sec=5, method='log_mel_mfcc_stack'):
