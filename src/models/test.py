...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment', type=str, required=True, 
                        ...
                        help="Name of the experiment to evaluate from config.yaml.")
    ...
    if params['model_architecture'] == 'cnn':
        output_neurons = 1 if args.experiment == 'detection' else num_classes
    ...
    plot_save_path = RESULTS_PATH / f"{args.experiment}_confusion_matrix.png"
